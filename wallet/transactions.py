...
class Transaction:
    """
    Document of an exchange in currency from one sender to another recipient.
    """
    ...
    def from_json(transaction_json):
        """
        Deserialize a transaction's json represention back into a Transaction instance
        """
    ...
    def is_valid_transaction(transaction):
        ...
        Raises an exception for an invalid transaction
        """
