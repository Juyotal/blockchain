...
class Listener(SubscribeCallback):
    ...
    def message(self, pubnub, messaage_object):
        ...
        elif messaage_object.channel == CHANNELS['TRANSACTION']:
            transaction = Transaction.from_json(messaage_object.message)
...
class PubSub():
    ...
    def broadcast_transaction(self, transaction):
        """
        this will Broadcast a transaction to all nodes
        """
